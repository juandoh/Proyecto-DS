...
public class ControladorInscripcion {
	...
	public int insertarInscripcion (String nombre_evento, String nombre_participante, String cedula, String fecha, String telefono, String email){
		...
		if(result == 1){JOptionPane.showMessageDialog(null, "Se realizo la inscripcion correctamente.");}
		else if(result == -1){JOptionPane.showMessageDialog(null, "No se pudo realizar la inscripcion.");}
