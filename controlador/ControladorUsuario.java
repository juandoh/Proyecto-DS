...
public class ControladorUsuario {
	...
	public int modificarUsuario( String nombre, String apellido, String cedula, String nick, String contrasenna,
			String telefono, String tipo, String estado, String email ){
		
		//se llama al dao para modificar
		System.out.println("Se va a modificar un Usuario");
		
		int result = daoUsuario.modificarUsuario(nombre, apellido, cedula, nick, contrasenna, telefono, tipo, estado, email);
